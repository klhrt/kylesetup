#!/bin/bash
sudo apt update
sudo apt install fish i3 compton neovim polybar feh firefox polybar xinit autorandr kitty nvidia-driver-525 pcmanfm redshift
cp -rd .config/ ~/
cp -rd Pictures/ ~/Pictures/
sudo cp -rd fonts/ /usr/share/fonts
